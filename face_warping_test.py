...
def test_pytorch_impl(frame, face_box, target_size, polar, offset, restore, square):
    # Preparation
...
def test_reference_impl(frame, face_box, target_size, polar, offset, restore, square):
    # Preparation
    if square:
