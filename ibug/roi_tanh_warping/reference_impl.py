...
def roi_tanh_warp(image: np.ndarray, roi: Tuple[float, float, float, float], target_size: Tuple[int, int],
...
def roi_tanh_restore(warped_image: np.ndarray, roi: Tuple[float, float, float, float], image_size: Tuple[int, int],
                     angular_offset: float = 0.0, interpolation: Optional[int] = cv2.INTER_LINEAR,
                     border_mode: Optional[int] = cv2.BORDER_CONSTANT, border_value: Any = 0) -> np.ndarray:
    roi_center = [(roi[0] + roi[2]) / 2.0, (roi[1] + roi[3]) / 2.0]
    half_roi_size = [(roi[2] - roi[0]) / 2.0, (roi[3] - roi[1]) / 2.0]
...
def roi_tanh_polar_warp(image: np.ndarray, roi: Tuple[float, float, float, float], target_size: Tuple[int, int],
                        angular_offset: float = 0.0, interpolation: Optional[int] = cv2.INTER_LINEAR,
...
def roi_tanh_polar_restore(warped_image: np.ndarray, roi: Tuple[float, float, float, float],
                           image_size: Tuple[int, int], angular_offset: float = 0.0,
...
def roi_tanh_circular_warp(image: np.ndarray, roi: Tuple[float, float, float, float], target_size: Tuple[int, int],
                           angular_offset: float = 0.0, interpolation: Optional[int] = cv2.INTER_LINEAR,
                           border_mode: Optional[int] = cv2.BORDER_CONSTANT, border_value: Any = 0,
                           keep_aspect_ratio: bool = False) -> np.ndarray:
    roi_center = [(roi[0] + roi[2]) / 2.0, (roi[1] + roi[3]) / 2.0]
...
def roi_tanh_circular_restore(warped_image: np.ndarray, roi: Tuple[float, float, float, float],
                              image_size: Tuple[int, int], angular_offset: float = 0.0,
                              interpolation: Optional[int] = cv2.INTER_LINEAR,
                              border_mode: Optional[int] = cv2.BORDER_CONSTANT,
                              border_value: Any = 0, keep_aspect_ratio: bool = False) -> np.ndarray:
...
def roi_tanh_polar_to_roi_tanh(warped_image: np.ndarray, roi: Tuple[float, float, float, float],
...
def roi_tanh_to_roi_tanh_polar(warped_image: np.ndarray, roi: Tuple[float, float, float, float],
                               target_size: Tuple[int, int] = (0, 0),
                               interpolation: Optional[int] = cv2.INTER_LINEAR,
                               border_mode: Optional[int] = cv2.BORDER_CONSTANT,
                               border_value: Any = 0, keep_aspect_ratio: bool = False) -> np.ndarray:
